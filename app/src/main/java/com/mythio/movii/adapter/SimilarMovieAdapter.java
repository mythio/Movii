...
import com.mythio.movii.util.RoundedCorners;
...
import static com.mythio.movii.util.RoundedCorners.Corners.ALL;
...
public class SimilarMovieAdapter extends RecyclerView.Adapter<SimilarMovieAdapter.MovieHolder> {
    ...
    public void onBindViewHolder(@NonNull MovieHolder movieHolder, int i) {
        ...
        Transformation transformation = new RoundedCorners(16, ALL);
