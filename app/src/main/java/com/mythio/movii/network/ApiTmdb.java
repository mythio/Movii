...
public interface ApiTmdb {
    ...
    @NonNull
    @GET("movie/{movie_id}")
    Single<Movie> getMovieDetail(
            @Path("movie_id") Integer movieId,
            @Query("api_key") String apiKey,
            @Query("append_to_response") String parameter
    );
    ...
    @NonNull
    @GET("tv/{tv_show_id}")
    Observable<TvShow> getTvShowDetail(
            @Path("tv_show_id") int tvShowId,
            @Query("api_key") String apiKey,
            @Query("append_to_response") String parameter
    );
    ...
    @NonNull
    @GET("search/tv")
    Observable<TvShowResponse> getTvShowSearchResults(
            @Query("api_key") String apiKey,
            @Query("query") String query
    );

    @GET("person/{cast_id}/movie_credits")
    Single<CastMovies> getCastMovies(
            @Path("cast_id") int id,
            @Query("api_key") String apiKey
    );
}
